...
class MinesweeperAI():
    ...
    def neighbors(self, cell):
        ...
        for dx in range(-1,2):
            for dy in range(-1,2):
                ...
                if ((cell[0] + dx) >= 0) and ((cell[1] + dy) >= 0):
                    if ((cell[0] + dx) < self.width) and ((cell[1] + dy) < self.height):
                        x = cell[0] + dx 
                        y = cell[1] + dy
                        Neighbours.add((x, y))
    ...
    def add_knowledge(self, cell, count):
        ...
        knowing = copy.deepcopy(self.knowledge)

        for sentence in knowing:
